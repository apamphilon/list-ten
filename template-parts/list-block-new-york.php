<div class="list-block section-padding">
  <div class="pagination">
    <a href="berlin" class="pagination__prev">
      <i class="fa fa-angle-left" aria-hidden="true"></i>
      <span class="visuallyhidden">prev</span>
      <span class="pagination__icon"></span>
    </a>
    <a href="manchester" class="pagination__next">
  ...
  <div class="container">
    ...
    <ul class="list-block__list" id="js-list-location-new-york">
      <li class="list-block__list-item">
        ...
        <h2 class="list-block__title">New York</h2>
    ...
    <div class="list-block__meta">
      <img src="http://placekitten.com/64/64" alt="" class="list-block__meta-image">
      <h3 class="list-block__meta-title">List by Martyn Roberts, aka Lenzie</h3>
    </div>
  </div>
</div>
